...
function ReceiveModal({ show, handleClose, formData, handleChange, handleSubmit, registroData, refresh }) {
  ...
  const { fornecedor, num_docto, valor, dt_lancamento, situacao, dt_vencimento, id, multa, juros, desconto, observacao } = registroData;
      ...
      <Modal.Body>
        {section === 'recebimento' && (
          <div className="registro-info">
            <p>
              Fornecedor: <span><b>{fornecedor}</b></span>
            </p>
